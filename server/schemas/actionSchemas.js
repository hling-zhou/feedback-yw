...
export const createActionBodySchema = {
  ...
  properties: {
    ...
    linkedInsightIds: { type: 'array', maxItems: 500, items: { type: 'string', maxLength: 256 } },
    evidenceRecordIds: { type: 'array', maxItems: 1000, items: { type: 'string', maxLength: 128 } },
    insightTheme: { type: 'string', maxLength: 256 },
    triggerMetric: { type: 'object', additionalProperties: true },
    recoveryValidation: { type: 'object', additionalProperties: true },
