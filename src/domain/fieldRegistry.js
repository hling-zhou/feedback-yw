...
const FIELD_DEFINITIONS = [
  ...
  {
    fieldKey: 'customerTypeName',
    displayName: '客户类型名称',
    recordPaths: ['sourceColumns.客户类型名称'],
    exportable: true,
    exportOrder: 23,
    importable: true,
    importOrder: 23,
  ...
  },
  {
    fieldKey: 'groupName',
    displayName: '集团名称',
    recordPaths: ['sourceColumns.集团名称'],
    exportable: true,
    exportOrder: 24,
    importable: true,
    importOrder: 24,
  ...
  {
    fieldKey: 'groupCustomerCode',
    displayName: '集团客户编码',
    recordPaths: ['sourceColumns.集团客户编码'],
    exportable: true,
    exportOrder: 25,
    importable: true,
    importOrder: 25,
  ...
  {
    fieldKey: 'groupProvince',
    displayName: '集团所属省份',
    recordPaths: ['sourceColumns.集团所属省份'],
    exportable: true,
    exportOrder: 26,
    importable: true,
    importOrder: 26,
  ...
  },
  {
    fieldKey: 'groupCity',
    displayName: '集团所属地市',
    recordPaths: ['sourceColumns.集团所属地市'],
    exportable: true,
    exportOrder: 27,
    importable: true,
    importOrder: 27,
  ...
  {
    fieldKey: 'loginAccountName',
    displayName: '登录账号名称',
    recordPaths: ['sourceColumns.登录账号名称'],
    exportable: true,
    exportOrder: 28,
    importable: true,
    importOrder: 28,
  ...
  {
    fieldKey: 'customerTierExport',
    displayName: '移动云客户服务等级',
    recordPaths: ['customerTier'],
    exportable: true,
    exportOrder: 29,
    importable: true,
    importOrder: 29,
  ...
  {
    fieldKey: 'complaintCauseReviewReason',
    displayName: '申请复核原因',
    recordPaths: ['complaintCauseReviewReason'],
    exportable: false,
    importable: false,
    manualDimension: 'complaintCauseReview',
    clusterRole: 'none',
