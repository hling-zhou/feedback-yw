...
export function createTicketRecord(input, opts = {}) {
  ...
  return {
    ...
    manualReviewAction: '',
    manualReviewOptimization: input.manualReviewOptimization || input.establishedAction || '',
    establishedAction: input.establishedAction || input.manualReviewOptimization || '',
    actionId: input.actionId || '',
    actionSchedule: input.actionSchedule || '',
    rootCauseReview: input.rootCauseReview || '',
    productGroupOptimization: input.productGroupOptimization || '',
    designerOptimization: input.designerOptimization || '',
