...
export const TOPIC_ANALYSIS_DEMO_LABEL = 'Demo 版'
export const TOPIC_ANALYSIS_DEMO_NOTE =
  '专题分析目前为演示版本。系统推荐默认看近 9 个月（近期 4 个月 vs 更早 5 个月）投诉/咨询/用后即评；只有新建专题时才指定周期。本地补充材料（Markdown / Word / PDF / Excel）可在报告详情中提供。客户身份按名称/编码近似匹配。'
